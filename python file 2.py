...
# Load the data
file_path = r"C:/Users/muqee/OneDrive/Desktop/CBTC- Internship/Unemployment in India.xlsx"
unemployment_data = pd.read_excel(file_path, sheet_name='Unemployment in India', engine='openpyxl')
